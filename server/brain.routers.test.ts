...
vi.mock("./db", () => ({
  ...
  getTimeBlockById: vi.fn().mockResolvedValue(null),
  updateTaskGoogleEventId: vi.fn().mockResolvedValue(undefined),
  updateTimeBlockGoogleEventId: vi.fn().mockResolvedValue(undefined),
